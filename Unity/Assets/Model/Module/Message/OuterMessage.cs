...
namespace ETModel {
  ...
  public partial class Frame_Joystick : pb::IMessage {
    private static readonly pb::MessageParser<Frame_Joystick> _parser = new pb::MessageParser<Frame_Joystick>(() => (Frame_Joystick)MessagePool.Instance.Fetch(typeof(Frame_Joystick)));
