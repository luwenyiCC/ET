...
namespace ETHotfix {
  ...
  public partial class C2M_ShipSkillRequest : pb::IMessage {
    private static readonly pb::MessageParser<C2M_ShipSkillRequest> _parser = new pb::MessageParser<C2M_ShipSkillRequest>(() => (C2M_ShipSkillRequest)MessagePool.Instance.Fetch(typeof(C2M_ShipSkillRequest)));
    public static pb::MessageParser<C2M_ShipSkillRequest> Parser { get { return _parser; } }
  ...
  public partial class M2C_ShipSkillResponse : pb::IMessage {
    private static readonly pb::MessageParser<M2C_ShipSkillResponse> _parser = new pb::MessageParser<M2C_ShipSkillResponse>(() => (M2C_ShipSkillResponse)MessagePool.Instance.Fetch(typeof(M2C_ShipSkillResponse)));
    public static pb::MessageParser<M2C_ShipSkillResponse> Parser { get { return _parser; } }
  ...
  public partial class C2R_RegisterAndLogin : pb::IMessage {
    private static readonly pb::MessageParser<C2R_RegisterAndLogin> _parser = new pb::MessageParser<C2R_RegisterAndLogin>(() => (C2R_RegisterAndLogin)MessagePool.Instance.Fetch(typeof(C2R_RegisterAndLogin)));
    public static pb::MessageParser<C2R_RegisterAndLogin> Parser { get { return _parser; } }
  ...
  public partial class R2C_RegisterAndLogin : pb::IMessage {
    private static readonly pb::MessageParser<R2C_RegisterAndLogin> _parser = new pb::MessageParser<R2C_RegisterAndLogin>(() => (R2C_RegisterAndLogin)MessagePool.Instance.Fetch(typeof(R2C_RegisterAndLogin)));
    public static pb::MessageParser<R2C_RegisterAndLogin> Parser { get { return _parser; } }
